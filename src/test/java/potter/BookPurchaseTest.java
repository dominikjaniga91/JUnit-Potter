...
public class BookPurchaseTest {
    ...
    @Test
    @DisplayName("Should return amount with best discount after purchase of 3 books - 2x1 and 1")
    void shouldReturnAmountWithDiscount_afterPurchase2And1Books(){
    ...
    @Test
    @DisplayName("Should return amount with best discount after purchase of 4 books - 2x2")
    ...
    @Test
    @DisplayName("Should return amount with best discount after purchase of 4 books - 2x1 and 2x1")
    void shouldReturnAmountWithDiscount_afterPurchase3And1Books(){
    ...
    @Test
    @DisplayName("Should return amount with best discount after purchase of 8 books - 6x2 and 2x1")
    ...
    @Test
    @DisplayName("Should return amount with best discount after purchase 23 books - 3x5 and 2x4")
    ...
    @Test
    @DisplayName("Should return amount with best discount after purchase 6 books - 3x2")
    ...
    @Test
    @DisplayName("Should return amount with best discount after purchase 7 books - 5x1 and 2x1")
